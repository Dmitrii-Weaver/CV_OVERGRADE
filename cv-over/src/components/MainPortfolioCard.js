...
const MainPortfolioCard = ({ title, description, imageUrl, tags, links }) => {
    ...
    return (
        <div className="relative overflow-hidden rounded-lg shadow-lg group transform transition duration-500 hover:scale-105">
            <img
                src={imageUrl}
                alt={title}
