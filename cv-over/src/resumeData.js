...
export default {
    ...
    services: [
        {
            ...
            description: "Design, implementation and assembly of web and Back End applications. 6 years of experience + Bachelor's degree.",
        },
        {
            title: "Game Developer",
            description: "Designed and developed smaller scale videogames on Game Maker and Unity, my own hand drawn designs and assets",
        },
        {
            title: "Illustrator",
    ...
    Portfolio: [
        ...
        },
        {
            ...
            links: [
                { link: "https://github.com/Dmitrii-Weaver/LandingAdvanced", iconType: "github" }
            ]
        },
        {
            tag: 'React',
            caption: "Developed a responsive web/mobile application for tracking and managing daily caffeine intake",
            ...
            links: [
                { link: "https://github.com/Dmitrii-Weaver/CaffeineTracker", iconType: "github" }
            ]
        },
        {
            tag: 'React',
            ...
            links: [
                { link: "https://snsprojectdweaver.vercel.app/auth", iconType: "web" }
            ]
        },
        {
            tag: 'Python',
            ...
            links: [
                { link: "https://github.com/Dmitrii-Weaver/PythonTest", iconType: "github" }
            ]
        },
        {
            tag: 'React',
        ...
        },
        {
            ...
            links: [
                { link: "https://www.cavokapp.com/", iconType: "web" }
            ]
        },
        {
            tag: 'C#',
            ...
            links: [
                { link: "https://keyloop.com/", iconType: "web" }
            ]
        },
        {
            tag: 'React',
            ...
            links: [
                { link: "https://fromchumbieswithlove.com/", iconType: "web" }
            ]
        },
        {
            tag: 'React',
            ...
            links: [
                { link: "https://github.com/Dmitrii-Weaver/CarChar", iconType: "github" }
            ]
        },
        {
            tag: 'React',
        ...
        },
        {
            ...
            desc: "Designed and developed online surveys based on client documentation and handling the output data.",
            links: [
                { link: "https://github.com/Dmitrii-Weaver/", iconType: "github" }
            ]
        }
